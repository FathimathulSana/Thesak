...
router.post('/blocked',sessionCheck.adminSession,adminController.getBlocked);
router.post('/unblocked',sessionCheck.adminSession,adminController.getUnBlocked);
...
router.post('/deleteCategory',sessionCheck.adminSession,categoryController.getDeleteCategory);
...
router.post('/deleteProduct',sessionCheck.adminSession,productController.getDeleteProduct)
...
router.post('/deleteCoupon',sessionCheck.adminSession,couponController.deleteCoupon);
...
router.post('/deleteBanner',sessionCheck.adminSession,bannerController.deleteBanner);
